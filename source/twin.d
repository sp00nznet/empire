...
int inhelp;
char[8] szAppName = "TextWin\0";

void helpRegister(HINSTANCE hInstance)
{
    WNDCLASSA wndclass;
    ...
    switch (message)
    {
          case WM_CREATE:
            ...
            try {
                ...
                buffer = cast(char[])"Help file not found.";
            }
            numlines = 0;
            nMaxWidth = 0;
            p = buffer.ptr;
          ...
          case WM_KEYDOWN:
               switch (wParam)
                    {
                    case VK_HOME:
                         SendMessageA(hwnd, WM_VSCROLL, SB_TOP, 0);
                         break;
                    ...
                    case VK_LEFT:
                         SendMessageA(hwnd, WM_HSCROLL, SB_PAGEUP, 0);
                         break;

                    case VK_RIGHT:
                         SendMessageA(hwnd, WM_HSCROLL, SB_PAGEDOWN, 0);
                         break;
