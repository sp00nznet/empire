...
struct Display
{
    ...
    do  // Changed from 'body' to 'do' for D2 compatibility
    {
        static immutable string[2][8] msg =
        [   [   "army",         "armies"        ],
            [   "fighter",      "fighters"      ],
        ...
        // For narrow displays
        static immutable string[2][8] msgn =
        [
            [   "A","As" ],
            [   "F","Fs" ],
            [   "D","Ds" ],
    ...
    void fncprt(Unit *u)
    {   static immutable char[9] dtab = "DEWQAZXC\0";   // directions
    ...
    {   static immutable string[] valmsg =
